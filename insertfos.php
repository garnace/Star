...
$picLoc=check_input($_POST["picLoc"],"City");
$picName=check_input($_POST["picName"],"write pic name");
$picDate=check_input($_POST["picDate"],"write date");
...
$picCom=check_input($_POST["picCom"],"write a comment");
...
$query="INSERT INTO pics VALUES ('','$picName' ,'$skyArea' ,'$skyEvent' ,'$picLoc','$picDate' ,'$picCom')";
